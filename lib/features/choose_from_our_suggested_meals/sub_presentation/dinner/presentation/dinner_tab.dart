...
class _DinnerTabState extends State<DinnerTab> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final hasPreviouslySelectedMeals = chooseFromOurSuggestedMealController.dinnerRecentChosenMeals.isNotEmpty;
      ...
      LoggerUtils.debug("🍽️ [OBX] hasPreviouslySelectedMeals=$hasPreviouslySelectedMeals");
      ...
      if (isLoading || (!hasJobId && !hasLoadedInitially)) {
        LoggerUtils.debug("🍽️ [OBX] >>> Showing LOADING indicator (loading=$isLoading, hasJobId=$hasJobId, hasLoadedInitially=$hasLoadedInitially)");
        return const Center(
