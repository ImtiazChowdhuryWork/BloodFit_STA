  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [
            /// Main Content - Always visible in background
                    ...
                    children: [
                      Obx(() {
                        ...
                        if (selectedDate == null || isCurrentDaySelected) {
                          ...
                          final selectedDayName = calandarController
                  ...
                  : Positioned.fill(
                      child: Container(
                        decoration: BoxDecoration(
                          color: Colors.black.withOpacity(0.8), // Glass effect
                        ),
                        child: const UpgradeYourPlanWidget(),
                      ),
                    );
            }),
          ],
