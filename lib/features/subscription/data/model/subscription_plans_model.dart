...
class GetSubscriptionPlansModel {
  ...
  factory GetSubscriptionPlansModel.fromRawJson(String str) =>
      GetSubscriptionPlansModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetSubscriptionPlansModel.fromJson(Map<String, dynamic> json) =>
      GetSubscriptionPlansModel(
...
class Feature {
  ...
  Feature({this.key, this.label, this.included, this.id});
...
class Limits {
  ...
  Limits({this.mealsPerWeek, this.mealsPerMonth});
...
class Pricing {
  ...
  Pricing({this.monthly, this.yearly});
...
class Monthly {
  ...
  factory Monthly.fromJson(Map<String, dynamic> json) =>
      Monthly(price: json["price"]?.toDouble());
