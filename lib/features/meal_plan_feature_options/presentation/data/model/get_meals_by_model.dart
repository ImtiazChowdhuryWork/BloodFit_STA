...
class GetMealsByDateModel {
    ...
    factory GetMealsByDateModel.fromRawJson(String str) => GetMealsByDateModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory GetMealsByDateModel.fromJson(Map<String, dynamic> json) => GetMealsByDateModel(
