  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // Pass container width to controller for saving calculations
        controller.setContainerWidth(containerWidth);

        final horizontalPadding =
            (containerWidth - (itemWidth.w + itemSpacing.w)) / 2;

        const double arrowSize = 50;
        const double numberGap = 4;
        ...
        return Stack(
          ...
          children: [
            ...
            Obx(() {
              ...
              return Positioned(
                bottom: height.h + 20.h,
                left: dividerCenterX - (arrowSize.w / 2),
                child: Column(
                  children: [
                    Text(
                      '$selectedNumber',
