...
// /// A customizable ruler-style picker supporting horizontal and vertical axes.
// /// Vertical mode: pointer is centered, number+icon left-aligned.
...
//           ),
//         ),
//         // Number + Icon aligned to left of pointer
//         Positioned(
...
//   final double
//   containerToSelectedValuePadding; // NEW: Padding between container and selected value + SVG
...
//     this.containerToSelectedValuePadding =
//         16.0, // NEW: Default padding between container and selected value
//   }) : assert(minValue <= initialValue && initialValue <= maxValue);
...
//                     containerToSelectedValuePadding
//                         .w, // USE THE NEW VARIABLE HERE
//                 top: 0,
//                 bottom: 0,
//                 child: Center(
//                   child: Row(
...
// // _HorizontalPointer and _RulerPainter remain the same
// class _HorizontalPointer extends StatelessWidget {
//   const _HorizontalPointer({
//     required this.selectedValue,
//     required this.selectedColor,
