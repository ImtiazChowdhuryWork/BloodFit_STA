...
class $AssetsFontsGen {
  ...
  /// List of all assets
  List<String> get values => [montserratRegular, poppinsRegular];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/blood_fit_splash_text.png
  ...
  /// File path: assets/images/onboarding_image_two.png
