  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final span = TextSpan(
          text: text,
          style: TextFontStyle.headline14w400c4d4d4dStylePoppins,
        );
        ...
        return Column(
          ...
          children: [
            Obx(
              () => Text(
                text,
                style: TextFontStyle.headline14w500c4d4d4dStylePoppins,
                  ...
                  child: Obx(
                    () => Text(
                      controller.isExpanded.value
                          ? "Read less"
                          : "Read more...",
                      style: TextFontStyle.headline14w700c989898StylePoppins,
                    ),
                  ),
                ),
              ),
